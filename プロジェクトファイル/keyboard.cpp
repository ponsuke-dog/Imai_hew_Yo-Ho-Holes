...
static Keyboard_State gOld_state = {};
static Keyboard_State gTrigger_state = {};
...
void Keyboard_Update(void)
{
    ...
    LPBYTE pt = (LPBYTE)&gTrigger_state;
    LPBYTE pn = (LPBYTE)now_state;
    LPBYTE po = (LPBYTE)&gOld_state;
...
{
    return Keyboard_IsKeyDown(key, &gTrigger_state);
}
